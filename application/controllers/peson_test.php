...
//    $fp_sel_req = new form_params(form_params::select,'Не указано',array('required','numeric'),'select_required','error_line','p_',TRUE,"Это поле обязательно нужно выбрать.",['numeric'=>'Значение должно быть числом.','required'=>'Это поле обязательно нужно выбрать.']);
//    $fp_sel_req = new form_params(form_params::select,'Не указано',array('required','numeric'),'select_required','error_line','p_',TRUE,"Это поле обязательно нужно выбрать.",['numeric'=>'Значение должно быть числом.','required'=>'Это поле обязательно нужно выбрать.']);
...
//    $ar[11] = new form_field_new_person('virus_hepatitis_c',[1 => 'Носитель', 2 => 'Нет'],$fp_sel_not_req,'Ваш пол:');


    //Тест
    $ar[12] = new form_field_new_person('multi_vibor[]',[1 => 'Пункт 1', 2 => 'Пункт 2',3 => 'Пункт 3', 4 => 'Пункт 4',5 => 'Пункт 5', 6 => 'Пункт 6'],$fp_sel_multi,'Много пунктов:');
